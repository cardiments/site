    ...
    connectedCallback() {
      ...
      <header style="text-align:center;">
          ...
          <div class="sc-bdfBwQ sc-gsTCUz cUWRuD bhdLno">
            <div class="flex">
              <a target="_blank" rel="noopener" title="Instagram" data-testid="SocialIcon" href="https://instagram.com/drumcardiments" aria-label="Instagram" class="sc-eCssSg lbrsth sc-hBEYos dWjUC">
                <svg enable-background="new 0 0 24 24" viewBox="0 0 24 24" class="sc-gKsewC fwXqBO"><title data-testid="svgTitle" id="title_0.8719583059881886">Instagram</title>
                  <path
